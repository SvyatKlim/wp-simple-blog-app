...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230503_neuigkeitenwebsite_bfe0621410815e087505_20230503111309_archive.zip';
        const ARCHIVE_SIZE       = '332474';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'bfe0621-03111309';
        const SECONDARY_PACKAGE_HASH = '43c0305-03111309';
